...
insert into product(tx_name, tx_description, ft_price, nu_stock, ft_discount, tx_image) values ('Kingston Digital 32GB 100 G3 USB 3.0', 'DataTraveler (DT100G3/32GB). En acuerdo con las especificaciones de USB 3.0 Compatiblidad dual Conectividad USB 3.0 Retro compatibilidad con USB 2.0 Diseño elegante de negro sobre negro y tapa deslizable Dispositivo inicial de almacenaje USB 3.0.', 119.95, 10, null, null);
insert into product(tx_name, tx_description, ft_price, nu_stock, ft_discount, tx_image) values ('Nikon D7200 DX-format DSLR Body', 'La primera DSLR de Nikon con funciones integradas de Wi-Fi y Comunicación de Campo Cercano (NFC). Colof negro.', 17118.98, 500, null, null);
insert into product(tx_name, tx_description, ft_price, nu_stock, ft_discount, tx_image) values ('Kingston Digital 240GB Solid State Drive', 'SSDNow UV400 SATA 3 2.5" SUV400S37/240G. Storage Capacity: 240GB SSD. Form Factor: 2.5-inch. Interface: SATA Rev. 3.0 (6Gb/S), with backwards compatibility to SATA Rev. 2.0 (3Gb/S).', 1814.27, 130, null, null);
